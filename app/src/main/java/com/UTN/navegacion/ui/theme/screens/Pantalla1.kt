...
import com.UTN.navegacion.DataSource.UserStore
...
fun Pantalla1(navController: NavController) {
    ...
    val userGuardado by userStore.userFlow.collectAsState(initial = null)
    ...
    CustomColumn {
        ...
        userGuardado?.let {
            Text("Datos Recuperados de DataStore:")
